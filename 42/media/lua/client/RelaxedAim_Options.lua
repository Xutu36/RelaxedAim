...
-- 手柄专属灵敏度：影响右摇杆瞄准时本体准心/捕捉圈的移动速度（仅手柄生效，不影响鼠标）。
config.gamepadSensitivity = options:addSlider("gamepadSensitivity", "UI_RelaxedAim_GamepadSensitivity", 0.25, 2.0, 0.05, 1.0, "UI_RelaxedAim_GamepadSensitivity_desc")
options:addDescription("UI_RelaxedAim_GamepadSensitivity_desc")
